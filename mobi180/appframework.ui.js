     ...
     ui.prototype = {
         ...
         */
          ...
          * This is called internally by loadContent.  Here we are using Ajax to fetch the data
            ```
            $.ui.loadDiv("http://mobi180.no1.35nic.com/wap/templates/default/js/ui/src/page.html",false,false,"up");
            ```
          * @param {String} target
          * @param {Boolean} newtab (resets history)
          * @param {Boolean} go back (initiate the back click)
         ...
         launch: function () {
             ...
             if (this.firstDiv) {
                 ...
                 var loadFirstDiv = function () {
                     ...
                     //ax6
                     $.query("#navbar >*>*").on("click", function (e) {
                         $.query("#navbar >*>*").not(e.currentTarget).removeClass("pressed");
                         $(e.currentTarget).addClass("pressed");
                     });

                     //update the width
                     var footerLinks = $.query("#navbar >*>*");
